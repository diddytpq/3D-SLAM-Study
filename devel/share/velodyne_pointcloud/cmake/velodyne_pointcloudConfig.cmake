...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/yoseph/worckspace/3D-SLAM-Study/src/velodyne_pkg/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/yoseph/worckspace/3D-SLAM-Study/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/yoseph/worckspace/3D-SLAM-Study/install)
...
if(NOT "/home/yoseph/worckspace/3D-SLAM-Study/devel/include;/home/yoseph/worckspace/3D-SLAM-Study/src/velodyne_pkg/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/yoseph/worckspace/3D-SLAM-Study/devel/include;/home/yoseph/worckspace/3D-SLAM-Study/src/velodyne_pkg/velodyne_pointcloud/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yoseph/worckspace/3D-SLAM-Study/src/velodyne_pkg/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
