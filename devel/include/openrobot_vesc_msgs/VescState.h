// Generated by gencpp from file openrobot_vesc_msgs/VescState.msg
// DO NOT EDIT!


#ifndef OPENROBOT_VESC_MSGS_MESSAGE_VESCSTATE_H
#define OPENROBOT_VESC_MSGS_MESSAGE_VESCSTATE_H
...
struct VescState_
{
  ...
  _pid_pos_now_type pid_pos_now;
   ...
   typedef int32_t _controller_id_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> const> ConstPtr;

}; // struct VescState_

typedef ::openrobot_vesc_msgs::VescState_<std::allocator<void> > VescState;

typedef boost::shared_ptr< ::openrobot_vesc_msgs::VescState > VescStatePtr;
typedef boost::shared_ptr< ::openrobot_vesc_msgs::VescState const> VescStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::openrobot_vesc_msgs::VescState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::openrobot_vesc_msgs::VescState_<ContainerAllocator1> & lhs, const ::openrobot_vesc_msgs::VescState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "d0f1524501b5a4208865a58f9472f3ff";
  }

  static const char* value(const ::openrobot_vesc_msgs::VescState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd0f1524501b5a420ULL;
  static const uint64_t static_value2 = 0x8865a58f9472f3ffULL;
};

template<class ContainerAllocator>
struct DataType< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "openrobot_vesc_msgs/VescState";
  }
...
template<class ContainerAllocator>
struct Definition< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::openrobot_vesc_msgs::VescState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::openrobot_vesc_msgs::VescState_<ContainerAllocator>& v)
  {
    ...
    Printer<int32_t>::stream(s, indent + "  ", v.controller_id);
  }
};
...
#endif // OPENROBOT_VESC_MSGS_MESSAGE_VESCSTATE_H
