...
"""autogenerated by genpy from openrobot_vesc_msgs/VescStateStamped.msg. Do not edit."""
import codecs
import sys
...
int32   controller_id"""
  ...
  _slot_types = ['std_msgs/Header','openrobot_vesc_msgs/VescState']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.state is None:
        self.state = openrobot_vesc_msgs.msg.VescState()
    else:
      self.header = std_msgs.msg.Header()
      self.state = openrobot_vesc_msgs.msg.VescState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_12didi().pack(_x.state.voltage_input, _x.state.temperature_pcb, _x.state.current_motor, _x.state.current_input, _x.state.speed, _x.state.duty_cycle, _x.state.charge_drawn, _x.state.charge_regen, _x.state.energy_drawn, _x.state.energy_regen, _x.state.displacement, _x.state.distance_traveled, _x.state.fault_code, _x.state.pid_pos_now, _x.state.controller_id))
