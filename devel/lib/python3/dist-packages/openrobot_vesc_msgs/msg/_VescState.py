...
"""autogenerated by genpy from openrobot_vesc_msgs/VescState.msg. Do not edit."""
import codecs
import sys
...
class VescState(genpy.Message):
  ...
  _type = "openrobot_vesc_msgs/VescState"
...
int32   controller_id"""
  ...
  __slots__ = ['voltage_input','temperature_pcb','current_motor','current_input','speed','duty_cycle','charge_drawn','charge_regen','energy_drawn','energy_regen','displacement','distance_traveled','fault_code','pid_pos_now','controller_id']
  _slot_types = ['float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','int32','float64','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       voltage_input,temperature_pcb,current_motor,current_input,speed,duty_cycle,charge_drawn,charge_regen,energy_drawn,energy_regen,displacement,distance_traveled,fault_code,pid_pos_now,controller_id
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_12didi().pack(_x.voltage_input, _x.temperature_pcb, _x.current_motor, _x.current_input, _x.speed, _x.duty_cycle, _x.charge_drawn, _x.charge_regen, _x.energy_drawn, _x.energy_regen, _x.displacement, _x.distance_traveled, _x.fault_code, _x.pid_pos_now, _x.controller_id))
